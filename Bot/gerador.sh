...
txt[315]=" ${FlT} DarkGH Keygen ${FlT} IS UPDATED!"
txt[316]=" ${aLerT} DarkGH Keygen ${aLerT} NEEDS UPDATE!"
...
fix_key() {
    ...
    msg -bar
    [[ -e /etc/menu_numito ]] && menumito="$(cat /etc/menu_numito)" || menumito="https://t.me/DarkGHPRO_bot"
    [[ -z $vkey ]] && vkey="@ChumoGH"
